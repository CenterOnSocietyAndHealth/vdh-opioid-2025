...
import { SectorCostsProps, Locality } from '@/app/types/locality'
...
export default function SectorCosts({ block, selectedLocality: propSelectedLocality, localities }: SectorCostsProps & { localities: Locality[] }) {
