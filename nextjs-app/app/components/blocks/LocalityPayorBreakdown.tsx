          ...
          <thead className="sticky top-0 bg-[#F3F2EC] z-10">
            <tr className="border-t border-b border-[#979797]">
              <th 
                ...
                aria-label={`Sort by Locality${sortColumn === 'locality' ? `, ${sortDirection === 'asc' ? 'ascending' : 'descending'}. Click or press enter to reverse.` : ''}`}
              ...
              <th 
                ...
                aria-label={`Sort by Families / Businesses${sortColumn === 'household' ? `, ${sortDirection === 'asc' ? 'ascending' : 'descending'}. Click or press enter to reverse.` : ''}`}
              ...
              <th 
                ...
                aria-label={`Sort by Federal Government${sortColumn === 'federal' ? `, ${sortDirection === 'asc' ? 'ascending' : 'descending'}. Click or press enter to reverse.` : ''}`}
                className="text-right py-1 px-0 text-[#6E6E6E] font-inter text-xs font-normal cursor-pointer hover:text-[#1E1E1E] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset transition-colors select-none"
              ...
              <th 
                ...
                aria-label={`Sort by State / Local Government${sortColumn === 'stateLocal' ? `, ${sortDirection === 'asc' ? 'ascending' : 'descending'}. Click or press enter to reverse.` : ''}`}
                className="text-right py-1 px-0 text-[#6E6E6E] font-inter text-xs font-normal cursor-pointer hover:text-[#1E1E1E] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset transition-colors select-none"
